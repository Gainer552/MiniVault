...
4. Once complete, your secure directory will be mounted at:
   ~/DIRECTORY_NAME
...
If you no longer need the container:
   ...
   2. Remove the empty mountpoint:
      rmdir ~/DIRECTORY_NAME
   3. Delete the container file:
      rm ~/DIRECTORY_NAME.img
...
On Arch Linux, you can install missing tools with:
   sudo pacman -S cryptsetup util-linux e2fsprogs
